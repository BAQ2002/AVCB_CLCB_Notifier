...
public class InternalPadding
{
    ...
    public InternalPadding(InnerControl owner) : this(owner, 0, 0, 0, 0) { }
    public InternalPadding(InnerControl owner, int all) : this(owner, all, all, all, all) { }
    public InternalPadding(InnerControl owner, int left, int top, int right, int bottom)
    {
        Owner = owner;
        Left = left;
        Top = top;
